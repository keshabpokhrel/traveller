    ...
    <div className="mainfooter">
      ...
      <center>
        <p>
          ...
          <br />
          <br />
          &copy;{new Date().getFullYear()} Adventure | All rights
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="text-white mt-4"> <span class="intro-1 ftintro-1">Do not Copy Right</span>
                    <div class="mt-2"> <span class="intro-2">Our Adventure Company website do not copy. Website copywriting is the process of writing digital content for landing pages, product pages, blog posts, and everything in between. Compelling copy can keep your website visitors engaged and lead them to take actions that are both important to you and meaningful to them.</span> </div>
                    <div class="mt-4 mb-5"> <button class="btn ftbtn-primary btn-primary" data-dismiss="modal"><i class="fa fa-close"></i> Close</button> </div>
                  </div>
                </div>
              </div>
